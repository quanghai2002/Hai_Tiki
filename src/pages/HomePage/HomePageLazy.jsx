  ...
  return (
    <Box>
      ...
      <Box className={clsx(style.wrapContent)}>
        <Grid xs={12} sm={12} md={12} lg={12} container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 2, lg: 3 }}>
          <Grid xs={12} sm={12} md={4} lg={2.2}>
            <Skeleton
              variant="rounded"
              width={210}
              height={60}
          ...
          <Grid container xs={12} sm={12} md={8} lg={9.8}>
